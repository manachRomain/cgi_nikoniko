...
<body>
	    ...
	    <div class="row-fluid">
	        ...
	        <div class="col-lg-2 col-xs-4">
	            <div class="row-fluid">
		               ...
		               <div align="right" class="row-fluid">
		                    <button onclick="location.href='./showverticale' " class="return"> Retour </button>
		               </div>
	            </div>
	        </div>
	    </div>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="col-lg-12">
	<h2 style = "text-decoration : underline; margin-bottom : 20px">Modifier la verticale de : ${page}  </h2>
				...
				<tr>
					...
					<td>
						<form action = "" method = "POST">
							<input type="hidden" name = "idVertical" value = "${item["id"]}">
							<input type="submit" value="Changer"><br>
